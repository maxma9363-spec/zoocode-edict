...
echo [ERROR] Provided folder is not the correct folder. Check if zoo code is installed and the path to your IDE's user data directory is correct.
goto error

:install
rem make backup of current custom_modes.yaml
