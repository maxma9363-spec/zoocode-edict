...
## Use of AI
> In this project, the installation scripts and `custom_modes.yaml` were written by the author. The `README.md` was initially generated by zoocode-edict and then reviewed and revised by the author. The `demo/`, `deploy/`, and `showcase/` directories were generated by zoocode-edict based on the author's requirements and guidance, and were tested and adjusted by the author.
